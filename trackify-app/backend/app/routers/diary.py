...
from ..services.library_service import get_owned_library_row, log_diary_entry
...
async def list_diary_entries(
    ...
    await get_owned_library_row(db, current_user, library_id)
...
async def create_diary_entry(
    ...
    library = await get_owned_library_row(db, current_user, library_id)
